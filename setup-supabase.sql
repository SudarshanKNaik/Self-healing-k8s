-- ============================================================================
-- Supabase Schema Setup for KubePulse + Cost Tracking
-- ============================================================================
...
-- 2. Endpoints table - stores ngrok URLs and metadata
...
-- 3. Metrics snapshots - real-time pod metrics
...
-- 5. Alerts table - triggered alerts
...
-- 6. Healing actions table - self-healing system logs
...
-- Create RLS policies for cost records
